...
- download from: [DSS Blog Github](https://github.com/dss-ialh/dss-blog/raw/master/static/img/featured-flag-templated.pptx)  
...
3. Insert the image into the blogpost using the *yaml* header (under the header section)  
`  image: “../../img/my_github_user_name/my_post_header_image.png”`

> The site will not serve if you do not close your PowerPoint slide deck.  
