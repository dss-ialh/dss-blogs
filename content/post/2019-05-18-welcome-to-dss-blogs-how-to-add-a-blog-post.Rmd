...
This is a guide on best practices and how to deploy your blog to be featured on the DSS Blog Site. All posts are peer reviewed by at least two members of the DSS team before posting. Whether you are a new member, part of the editorial team, or an Acting Admin, this guide will serve as a road map for blog posts.
...
2. Place the image into “*./static/img/my_github_user_name/my_post_image.png*”  
2. Insert the image into the blogpost using the *yaml* header (under the header section)  
`  image: “../../img/my_github_user_name/imagename.png”`

#### Create Summary Text and Link {#summarytext}

1. Try to use abstract style summaries when possible
...
3. The maximum number of characters that will display is 250, anything more will be replaced with '...' in the preview.
...
* The last person to give approval for publication must request the Acting Admin (AA) to __Merge__, and serve the updated version of the site (use a comment on the pull request  
...
4. __Push__ the site
5. __Check__ that the new post is now accessible from the site
